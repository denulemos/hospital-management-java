...
public class PatientController {
    ...
    public ResultSet getAllPatients (String id) throws SQLException {
     ...
     public ResultSet getPatientById (String id) throws SQLException {
      ...
      public void editPatient (String id, String fullname, String history, String gender) throws SQLException {
        Statement statement = ConnectionProvider.getConnection().createStatement();
        statement.executeUpdate("UPDATE patients SET fullname='" + fullname + "', history='" + history + "', gender = '" + gender + "' WHERE (ID =" + id + ")");
